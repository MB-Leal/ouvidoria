                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="canal" class="form-label">
                                    Canal de Entrada <span class="text-danger">*</span>
                                </label>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        anonimoCheckbox.addEventListener('change', toggleDadosPessoais);
        toggleDadosPessoais(); // Executar no carregamento
